...
export const Navbar=({isProductList=false})=> {
  ...
  return (
    <AppBar position="sticky" sx={{backgroundColor:"white",boxShadow:"var(--shadow-xs)",color:"text.primary"}}>
        <Toolbar sx={{p:1,height:"4rem",display:"flex",justifyContent:"space-around"}}>

          <Typography variant="h2" noWrap component="a" href="/" sx={{ mr: 2, display: { xs: 'none', md: 'flex' },fontWeight: 900,  color: 'inherit', textDecoration: 'none', }}>
                            <img style={{cursor:"pointer", height:"13rem"}} src={Ziza} alt="Ziza" />
          </Typography>
